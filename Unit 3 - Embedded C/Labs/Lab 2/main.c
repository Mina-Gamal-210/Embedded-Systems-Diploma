...
char G_Array[23] = "Mina Gamal Fayez Labib";  //Creating a global array to be stored in .data section
static int b[3];  // Creating an uninitialized static global array to be stored in .bss section
const int c = 10; //Creating a const global variable to be stored in.rodata section
